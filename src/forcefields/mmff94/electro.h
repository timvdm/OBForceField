...
namespace OBFFs {
  ...
  class MMFF94ElectroTerm : public OBFunctionTerm
  {
    public:
      struct Calculation
      {
      ...
      MMFF94ElectroTerm(OBFunction *function, MMFF94Common *common);
      std::string GetName() const { return "MMFF94 electrostatic term"; }
