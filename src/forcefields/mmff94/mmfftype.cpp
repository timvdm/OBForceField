...
namespace OBFFs {
  ...
  MMFF94Type::MMFF94Type()
  {
    m_database = static_cast<OBParameterDB*>(new MMFF94ParameterDB("/home/timvdm/OBForceField/git_repo/data/mmff94.ff"));
  }
  ...
  bool MMFF94Type::PerceiveAromaticity(/*const*/ OBMol &mol)
  {
  ...
  //   MMFF94 V - Table I
  //
  int MMFF94Type::GetType(OBAtom *atom)
  {
  ...
  bool MMFF94Type::SetTypes(const OBMol &mol)
  {
    ...
    bool done = true;
    while (done) {
      done = PerceiveAromaticity(const_cast<OBMol&>(mol));
    }
  
    cout << "-----------------------------------------------" << endl;
    
    OBAtomIterator iter;
    for (OBAtom *atom = const_cast<OBMol&>(mol).BeginAtom(iter); atom; atom = const_cast<OBMol&>(mol).NextAtom(iter)) {
      m_types.push_back(GetType(atom));
      std::stringstream ss;
      ss << m_types.back();
      m_atoms.push_back(ss.str());
      cout << m_types.back() << endl;
    }
    
    return true;
  }
  
  bool MMFF94Type::SetFormalCharges(/*const*/ OBMol &mol)
  {
  ...
  bool MMFF94Type::SetPartialCharges(/*const*/ OBMol &mol)
  {
    ...
    FOR_ATOMS_OF_MOL (atom, mol) {
      ...
      FOR_NBORS_OF_ATOM (nbr, &*atom) {
        ...
        query.push_back( OBParameterDBTable::Query(0, OBVariant(bondType)) );
        query.push_back( OBParameterDBTable::Query(1, OBVariant(type), true) );
        query.push_back( OBParameterDBTable::Query(2, OBVariant(nbr_type), true) );
        bool swapped;
        OBParameterDBTable *chargeTable = m_database->GetTable("Charge Parameters");
        std::vector<OBVariant> row = chargeTable->FindRow(query, &swapped);
        ...
        if (!bci_found) {
          OBParameterDBTable *pbciTable = m_database->GetTable("Partial Bond Charge Increments");
          std::vector<OBParameterDBTable::Query> query_a;
          query.push_back( OBParameterDBTable::Query(0, OBVariant(type)) );
          std::vector<OBVariant> row_a = pbciTable->FindRow(query);
          if (row_a.size())
            Pa = row_a.at(1).AsDouble();

          std::vector<OBParameterDBTable::Query> query_b;
          query.push_back( OBParameterDBTable::Query(0, OBVariant(nbr_type)) );
          std::vector<OBVariant> row_b = pbciTable->FindRow(query);
          if (row_b.size())
  ...
  //
  int MMFF94Type::GetBondType(OBAtom* a, OBAtom* b)
  {
  ...
  int MMFF94Type::GetAngleType(OBAtom* a, OBAtom* b, OBAtom *c)
  {
    int sumbondtypes;
  ...
  int MMFF94Type::GetStrBndType(OBAtom* a, OBAtom* b, OBAtom *c)
  {
    int btab, btbc, atabc;
    bool inverse;
  ...
  //
  int MMFF94Type::GetTorsionType(OBAtom* a, OBAtom* b, OBAtom *c, OBAtom *d)
  {
    OBMol *mol = a->GetParent();
    int btab, btbc, btcd;
  ...
  // CXB = MC * (I * MA + J) + BTij
  unsigned int MMFF94Type::GetCXB(int type, int a, int b)
  {
    unsigned int cxb;
    cxb = 2 * (a * 136 + b) + type;
    return cxb;
  ...
  unsigned int MMFF94Type::GetCXA(int type, int a, int b, int c)
  {
    unsigned int cxa;
  ...
  unsigned int MMFF94Type::GetCXS(int type, int a, int b, int c)
  {
    unsigned int cxs;
  ...
  unsigned int MMFF94Type::GetCXO(int a, int b, int c, int d)
  {
    unsigned int cxo;
  ...
  unsigned int MMFF94Type::GetCXT(int type, int a, int b, int c, int d)
  {
    unsigned int cxt;
  ...
  // CXQ = MC * (I * MA + J) + BTij
  unsigned int MMFF94Type::GetCXQ(int type, int a, int b)
  {
    unsigned int cxq;
    cxq = 2 * (a * 136 + b) + type;
    return cxq;
  ...
  // MMFF part V - TABLE I
  bool MMFF94Type::HasLinSet(int atomtype)
  {
    OBParameterDBTable *propTable = m_database->GetTable("Atom Properties");
    std::vector<OBParameterDBTable::Query> query;
    query.push_back( OBParameterDBTable::Query(0, OBVariant(atomtype)) );
    const std::vector<OBVariant> &row = propTable->FindRow(query);
    if (row.size())
  ...
  // MMFF part V - TABLE I
  bool MMFF94Type::HasPilpSet(int atomtype)
  {
    OBParameterDBTable *propTable = m_database->GetTable("Atom Properties");
    std::vector<OBParameterDBTable::Query> query;
    query.push_back( OBParameterDBTable::Query(0, OBVariant(atomtype)) );
  ...
  // MMFF part V - TABLE I
  bool MMFF94Type::HasAromSet(int atomtype)
  {
    OBParameterDBTable *propTable = m_database->GetTable("Atom Properties");
    std::vector<OBParameterDBTable::Query> query;
    query.push_back( OBParameterDBTable::Query(0, OBVariant(atomtype)) );
  ...
  // MMFF part V - TABLE I
  bool MMFF94Type::HasSbmbSet(int atomtype)
  {
    OBParameterDBTable *propTable = m_database->GetTable("Atom Properties");
    std::vector<OBParameterDBTable::Query> query;
    query.push_back( OBParameterDBTable::Query(0, OBVariant(atomtype)) );
  ...
  // MMFF part V - TABLE I
  int MMFF94Type::GetCrd(int atomtype)
  {
    OBParameterDBTable *propTable = m_database->GetTable("Atom Properties");
    std::vector<OBParameterDBTable::Query> query;
    query.push_back( OBParameterDBTable::Query(0, OBVariant(atomtype)) );
  ...
  // MMFF part V - TABLE I
  int MMFF94Type::GetVal(int atomtype)
  {
    OBParameterDBTable *propTable = m_database->GetTable("Atom Properties");
    std::vector<OBParameterDBTable::Query> query;
    query.push_back( OBParameterDBTable::Query(0, OBVariant(atomtype)) );
  ...
  // MMFF part V - TABLE I
  int MMFF94Type::GetMltb(int atomtype)
  {
    OBParameterDBTable *propTable = m_database->GetTable("Atom Properties");
    std::vector<OBParameterDBTable::Query> query;
    query.push_back( OBParameterDBTable::Query(0, OBVariant(atomtype)) );
  ...
  int MMFF94Type::EqLvl2(int type)
  {
    OBParameterDBTable *levelTable = m_database->GetTable("Atom Type Levels");
    std::vector<OBParameterDBTable::Query> query;
    query.push_back( OBParameterDBTable::Query(0, OBVariant(type)) );
    const std::vector<OBVariant> &row = levelTable->FindRow(query);
    if (row.size())
  ...
  // MMFF part I - TABLE IV
  int MMFF94Type::EqLvl3(int type)
  {
    OBParameterDBTable *levelTable = m_database->GetTable("Atom Type Levels");
    std::vector<OBParameterDBTable::Query> query;
    query.push_back( OBParameterDBTable::Query(0, OBVariant(type)) );
  ...
  // MMFF part I - TABLE IV
  int MMFF94Type::EqLvl4(int type)
  {
    OBParameterDBTable *levelTable = m_database->GetTable("Atom Type Levels");
    std::vector<OBParameterDBTable::Query> query;
    query.push_back( OBParameterDBTable::Query(0, OBVariant(type)) );
  ...
  // MMFF part I - TABLE IV
  int MMFF94Type::EqLvl5(int type)
  {
    OBParameterDBTable *levelTable = m_database->GetTable("Atom Type Levels");
    std::vector<OBParameterDBTable::Query> query;
    query.push_back( OBParameterDBTable::Query(0, OBVariant(type)) );
  ...
  double MMFF94Type::GetZParam(OBAtom* atom)
  {
    if (atom->IsHydrogen())
      return 1.395;
    if (atom->IsCarbon())
  ...
  // MMFF part V - TABLE VI
  double MMFF94Type::GetCParam(OBAtom* atom)
  {
  ...
  // MMFF part V - TABLE X
  double MMFF94Type::GetUParam(OBAtom* atom)
  {
    if (atom->IsCarbon())
      return 2.0;
    if (atom->IsNitrogen())
  ...
  // MMFF part V - TABLE X
  double MMFF94Type::GetVParam(OBAtom* atom)
  {
    if (atom->IsCarbon())
      return 2.12;
    if (atom->IsNitrogen())
  ...
  double MMFF94Type::GetCovalentRadius(OBAtom* a) {
  ...
  double MMFF94Type::GetBondLength(OBAtom* a, OBAtom* b)
  {
    double rab;
    ...
    OBParameterDBTable *bondTable = m_database->GetTable("Bond Parameters");

    std::vector<OBParameterDBTable::Query> query;
    query.push_back( OBParameterDBTable::Query(0, OBVariant(bondType)) );
    query.push_back( OBParameterDBTable::Query(1, OBVariant(type_a)) );
    query.push_back( OBParameterDBTable::Query(2, OBVariant(type_b)) );
    std::vector<OBVariant> row = bondTable->FindRow(query);
    if (!row.size()) {
      // try inverse order
      OBParameterDBTable::Query swap(query[1]);
      query[1] = query[2];
      query[2] = swap;
      row = bondTable->FindRow(query);
    }
  ...
  double MMFF94Type::GetRuleBondLength(OBAtom* a, OBAtom* b)
  {
  ...
  bool MMFF94Type::IsInSameRing(OBAtom* a, OBAtom* b)
  {
    OBMol *mol = a->GetParent();
    bool a_in, b_in;
    vector<OBRing*> vr;
  ...
  bool MMFF94Type::IsAromatic(OBRing *ring) const
  {
  ...
  int MMFF94Type::GetElementRow(OBAtom *atom)
  {
    int row;
  ...
  std::string MMFF94Type::MakeBondName(const OBMol &mol, unsigned int iA, unsigned int iB)
  {
    OBAtom *a = mol.GetAtom(iA+1);
    OBAtom *b = mol.GetAtom(iB+1);
    std::stringstream ss;
    if (m_types.at(iA) <= m_types.at(iB))
      ss << GetBondType(a, b) << ":" << m_atoms.at(iA) << "-" << m_atoms.at(iB);
    else
      ss << GetBondType(a, b) << ":" << m_atoms.at(iB) << "-" << m_atoms.at(iA);
    return ss.str();
  }

  std::string MMFF94Type::MakeAngleName(const OBMol &mol, unsigned int iA, unsigned int iB, unsigned int iC)
  {
    OBAtom *a = mol.GetAtom(iA+1);
    OBAtom *b = mol.GetAtom(iB+1);
    OBAtom *c = mol.GetAtom(iC+1);
    std::stringstream ss;
    ss << GetAngleType(a, b, c) << ":" << m_atoms.at(iA) << "-" << m_atoms.at(iB) << "-" << m_atoms.at(iC);
    return ss.str();
  }

  std::string MMFF94Type::MakeStrBndName(const OBMol &mol, unsigned int iA, unsigned int iB, unsigned int iC)
  {
    OBAtom *a = mol.GetAtom(iA+1);
    OBAtom *b = mol.GetAtom(iB+1);
    OBAtom *c = mol.GetAtom(iC+1);
    std::stringstream ss;
    ss << GetStrBndType(a, b, c) << ":" << m_atoms.at(iA) << "-" << m_atoms.at(iB) << "-" << m_atoms.at(iC);
    return ss.str();
  }

  std::string MMFF94Type::MakeTorsionName(const OBMol &mol, unsigned int iA, unsigned int iB, unsigned int iC, unsigned int iD)
  {
    OBAtom *a = mol.GetAtom(iA+1);
    OBAtom *b = mol.GetAtom(iB+1);
    OBAtom *c = mol.GetAtom(iC+1);
    OBAtom *d = mol.GetAtom(iD+1);
    std::stringstream ss;
    ss << GetTorsionType(a, b, c, d) << ":" << m_atoms.at(iA) << "-" << m_atoms.at(iB) << "-" << m_atoms.at(iC) << "-" << m_atoms.at(iD);
    return ss.str();
  }

  std::string MMFF94Type::MakeOOPName(const OBMol &mol, unsigned int iA, unsigned int iB, unsigned int iC, unsigned int iD)
  {
    OBAtom *a = mol.GetAtom(iA+1);
    OBAtom *b = mol.GetAtom(iB+1);
    OBAtom *c = mol.GetAtom(iC+1);
    OBAtom *d = mol.GetAtom(iD+1);
    std::stringstream ss;
    ss << m_atoms.at(iA) << "-" << m_atoms.at(iB) << "-" << m_atoms.at(iC) << "-" << m_atoms.at(iD);
    return ss.str();
